...
function App() {
    ...
    var loadBlockchainData = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = (0, interactions_1.loadProvider)(dispatch);
                    return [4 /*yield*/, (0, interactions_1.loadNetwork)(provider, dispatch)];
                case 1:
                    chainId = _a.sent();
                    ...
                    return [4 /*yield*/, (0, interactions_1.loadTokens)(provider, chainId, dispatch)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, interactions_1.loadAMM)(provider, chainId, dispatch)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return (react_1.default.createElement(react_bootstrap_1.Container, { className: "bg-lt-g", style: { height: '100%' } },
        react_1.default.createElement(react_router_dom_1.HashRouter, null,
            ...
            react_1.default.createElement(react_router_dom_1.Routes, null,
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: "/deposit", element: react_1.default.createElement(Deposit_1.default, null) }),
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: "/charts", element: react_1.default.createElement(Charts_1.default, null) })))));
}
exports.default = App;
