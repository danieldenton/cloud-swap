...
var ButtonComponent = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, spinner ? (react_1.default.createElement(Spinner_1.default, { animation: "border", style: {
            display: "block",
            margin: "0 auto",
            color: "purple",
            marginTop: "25px",
        } })) : (react_1.default.createElement(Button_1.default, { type: "submit", className: "fw-bold", style: {
