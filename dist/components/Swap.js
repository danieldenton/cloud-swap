...
var Swap = function () {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(Card_1.default, { style: {
            ...
            react_1.default.createElement(InputWithSelection_1.default, { title: "Input", disabled: !inputToken, handleToken: handleInputToken, token: inputToken, symbols: symbols, balances: balances, handleInput: handleInput, value: null }),
            react_1.default.createElement(InputWithSelection_1.default, { title: "Output", disabled: true, handleToken: handleOutputToken, token: outputToken, symbols: symbols, balances: balances, handleInput: null, value: outputAmount }),
