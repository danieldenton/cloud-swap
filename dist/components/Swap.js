    ...
    var handleInput = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    result = _a.sent();
                    _token2Amount = ethers_1.utils.formatUnits(result[0].toString(), "ether");
                    _fee = ethers_1.utils.formatUnits(result[1].toString(), "ether");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _inputAmount = ethers_1.utils.parseUnits(inputAmount, "ether");
