...
var AlertComponent_tsx_1 = __importDefault(require("./AlertComponent.tsx"));
var Alert = function (_a) {
    ...
    var alerts = alertProps.map(function (a, idx) {
        return (react_1.default.createElement(AlertComponent_tsx_1.default, { key: idx, message: a.message, transactionHash: a.transactionHash, variant: a.variant, setShowAlert: setShowAlert }));
    });
